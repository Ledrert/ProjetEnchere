...
<form>
	<div class="centerNewArticle">
		...
		<div>
			...
			<input type="text" id="article" name="article"  maxlength="30" value="${article.getNomArticle}">
		</div>
		<div>
		...
		<div>
		<label for="prix">Mise à prix : </label> <input type="number" id="prix" name="prix" min="1" max="100000"> 
		</div>
		<div>
